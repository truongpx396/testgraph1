...
export class MasterChef extends ethereum.SmartContract {
  ...
  pendingCake(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingCake",
  ...
  try_pendingCake(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingCake",
      "pendingCake(uint256,address):(uint256)",
      [
